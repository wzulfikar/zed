...
impl AcpThreadView {
    ...
    fn render_turn_stats(
        ...
        let leading_icon = {
            let container = h_flex().w(px(18.)).justify_center();
            if is_generating {
    ...
    fn render_thread_controls(
        ...
        h_flex()
            ...
            .hover(|s| s.opacity(1.))
            .justify_between()
            .child(self.render_turn_stats(is_generating, waiting_confirmation, cx))
            .when(!waiting_confirmation && !is_generating, |this| {
